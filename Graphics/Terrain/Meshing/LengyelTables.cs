...
public static class LengyelTables
{
    ...
    {
        public readonly byte GeometryCounts = gc; // High nibble is vertex count, low nibble is triangle count.
        public readonly byte[] VertexIndex = vi;  // Groups of 3 indexes giving the triangulation.
