...
public struct DensityTask
{
    ...
    public DensityTask(WorldSettings worldSettings, WorldState worldState, GeneratorSettings settings, in ChunkUpdate chunkUpdate)
    {
        ...
        DensityData = new List<float>(densitySize * densitySize * densitySize);
        Size = densitySize;
        Step = lodScale;
